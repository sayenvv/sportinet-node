...
const register = async (req, res) => {
    ...
    try {
        ...
        if (existingUser) {
            ...
            if (!isOTPValid(existingUser.created_at) && existingUser.account_status === AccountTypes.PENDING || existingUser.temp_otp == null && existingUser.account_status === AccountTypes.PENDING) {
                // Regenerate OTP
